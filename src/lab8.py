...
# 레이아웃 트리(렌더 트리): DOM과 화면 사이의 중간 구조.
# 레이아웃 객체(BlockLayout, InputLayout 등)가 배치/페인트/히트테스트를 담당.
# 새 렌더링 규칙이 필요할 때 새 레이아웃 객체 타입을 추가하는 게 확장의 일반적인 방법.
class InputLayout:
    ...
    def paint(self):
        ...
        if self.node.tag == "input":
            ...
            # 버튼에 텍스트 노드가 딱 하나만 있으면 표시, 아니면 무시
